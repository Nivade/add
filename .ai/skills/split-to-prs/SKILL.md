...
Turn one pile of work into a few small, separately reviewable slices.

This repo has no remote: a slice lands as a local branch with its own commits,
and the push/PR steps below are skipped until a remote exists.
